...
export default function TypeALicense() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = { ...formData, miner_id: user.id, category: 'B' };
    ...
    <div className={`relative min-h-screen ${isDarkMode ? 'bg-gradient-to-br from-gray-900 via-black to-gray-900' : 'bg-gradient-to-br from-gray-50 via-white to-gray-100'} overflow-hidden`}>
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center pt-24 pb-16">
        <div className="w-full max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className={`text-4xl md:text-5xl font-extrabold mb-3 tracking-tight ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>IML Type B License Application</h1>
            <p className="text-lg md:text-xl max-w-2xl mx-auto text-center font-light mb-2 text-black">Complete the form below to apply for your Industrial Mining License Type B</p>
          </motion.div>
          {/* Form Container */}
          <motion.div 
